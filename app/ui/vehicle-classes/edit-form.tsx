import { VehicleCategoryName, VehiclesTable } from '@/app/lib/definitions';
...
export default function EditVehicleForm({
  ...
  vehicleTypes: VehicleCategoryName[];
}) {
  const updateVehicleWithId = updateVehicle.bind(null, vehicle.classid);
  // console.log(vehicle);
  ...
  return (
    <form action={updateVehicleWithId}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div className="mb-4">
          ...
          <div className="relative mt-2 rounded-md">
            <input
              ...
              name="classname"
              type="text"
              defaultValue={vehicle.classname}
          ...
          <div className="relative">
            ...
            >
              ...
              {vehicleTypes.map((type) => (
                <option key={type.classid} value={type.classid}>
                  {type.categoryname}
                </option>
              ))}
            </select>
        ...
        {/* Published Status */}
        <fieldset>
          <legend className="mb-2 block text-sm font-medium">Set the published status</legend>
            ...
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="not published"
                  defaultChecked={vehicle.published === 'not published'}
              ...
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="published"
                  defaultChecked={vehicle.published === 'published'}
                  className="h-4 w-4 cursor-pointer border-gray-300 bg-gray-100 text-gray-600 focus:ring-2"
                />
                <label
                  htmlFor="published"
